...
"""
Build for individual retry on top of a function. (Example just one in activity)
However I just added the retry policy thoroughly in temporal.
So this might come as a future requirement actually. Not maybe currently required I assume so. 
But it is a good utility to have.
